...
class PagosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pago" do
    assert_difference('Pago.count') do
      post pagos_url, params: { pago: { grupo_id: @pago.grupo_id, user_id: @pago.user_id, valor: @pago.valor } }
    end
  ...
  test "should update pago" do
    patch pago_url(@pago), params: { pago: { grupo_id: @pago.grupo_id, user_id: @pago.user_id, valor: @pago.valor } }
